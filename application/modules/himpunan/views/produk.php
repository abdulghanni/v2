<div class="main--breadcrumb">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="active"><span>Produk Hukum</span></li>
        </ul>
    </div>
</div>
            ...
            <div class="main--content col-md-9 col-sm-7" data-sticky-content="true">
                <div class="sticky-content-inner">
                    <div class="page--title ptop--30">
                        <h2 class="h2">Produk Hukum</h2> </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-12 col-xs-8 col-xxs-12">
                                            <div class="post--info">
                                                ...
                                                <div class="title">
                                                    <h3 class="h4"><a href="<?=site_url('himpunan/produkhukum_detail')?>/<?=$entry->entry_id?>"><?=$entry->c_description.' Nomor '.$entry->title.' Tahun '.$entry->regyear?></a></h3> </div>
                                            </div>
                                            <div class="post--content">
                                                <div class="" style="font-size: 10px"><?=$entry->e_description?></div>
                                            </div>
                                            <div class="post--action"> <a href="<?=base_url('himpunan/produk_download/'.$entry->entry_id)?>" target="_blank"><i class="fa fa-download"></i> Unduh</a> </div>
                                        </div>
                                    </div>
                                </div>
                            </li>
