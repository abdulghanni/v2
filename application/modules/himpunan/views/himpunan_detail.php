<div class="main--breadcrumb">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li><a href="#" class="btn-link">Himpunan Perundangan</a></li>
            <li class="active"><span>Himpunan Perundangan Detail</span></li>
        </ul>
    </div>
</div>
                            ...
                            <div class="col-md-12 pbottom--30">
                                <div class="product--summery">
                                    ...
                                    <form action="#" class="cart">
                                         <a href="<?=base_url('himpunan/himpunan_download/'.$l->entry_id)?>" class="btn btn-primary"><i class="fa fa-download"> Unduh</i></a></form>
