...
class Peraturan_gubernur extends MX_Controller {
    public $data;
    var $module = 'admin';
    var $title = 'Peraturan Gubernur';
    var $file_name = 'peraturan_gubernur';
    var $table = 'pages';
    var $content = 'tata-cara-penyusunan-peraturan-gubernur';
