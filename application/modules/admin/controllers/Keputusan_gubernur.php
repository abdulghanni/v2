...
class Keputusan_gubernur extends MX_Controller {
    public $data;
    var $module = 'admin';
    var $title = 'Keputusan Gubernur';
    var $file_name = 'keputusan_gubernur';
    var $table = 'pages';
    var $content = 'tata-cara-penyusunan-keputusan-gubernur';
