              ...
              <div class="row">
                <div class="col-md-12">
                  <?php foreach($photo as $r){?>
                    <div class="col-md-4">
                      <button class="btn btn-xs btn-danger" type="button" onclick="deleteImg('<?=$r->id?>')"><i class="fa fa-remove"></i> Hapus Gambar</button><br/>
