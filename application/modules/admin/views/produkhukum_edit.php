      ...
      <div class="col-md-12 col-sm-12 col-xs-12">
        <div class="x_panel">
          ...
          <div class="x_content">
              ...
              <div class="form-group">
                <label class="control-label col-md-3 col-sm-3 col-xs-12">Riwayat
                </label>
                <div class="col-md-6 col-sm-6 col-xs-12">
                  <textarea name="riwayat" style="width: 100%"><?=$entries->riwayat?></textarea>
                </div>
              </div>
              <div class="ln_solid"></div>
              <div class="form-group">
                <div class="col-md-6 col-sm-6 col-xs-12 col-md-offset-3">
                  <a href="<?=base_url('admin/produk_hukum')?>"><button class="btn btn-primary" type="button">Cancel</button>
