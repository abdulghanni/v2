              ...
              <div class="col-md-12 col-sm-12 col-xs-12">
                <div class="x_panel">
                  ...
                  <div class="x_content">
                    ...
                    <div class="x_panel">
                      <div class="x_content">
                        <?php echo form_open_multipart('admin/berita/do_add', array('class'=>'form-horizontal form-label-right'));?>
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-6 col-sm-6 col-xs-12">
                            <input type="text" id="last-name" name="keyword" required="" class="form-control col-md-7 col-xs-12">
                          </div>
                        </div>

                        <div class="form-group">
                          <label class="control-label col-md-2 col-sm-3 col-xs-12">Gambar Berita</label>
                          <div class="col-md-6 col-sm-6 col-xs-12">
                        ...
                        <div class="form-group">
                          ...
                          <div class="col-md-12 col-sm-12 col-xs-12">
                            ...
                            isi popup notifikasi disini..." name="body"></textarea>
                          </div>
                        </div>
                        <br/>
                        <br/>
