              ...
              <div class="row">
                <div class="col-md-12">
                  <?php foreach($data as $r){?>
                    <div class="col-md-4">
                      <button class="btn btn-xs btn-danger" type="button" onclick="deleteImg('<?=$r->img_name?>')"><i class="fa fa-remove"></i> Hapus Gambar</button><br/>
                      <img height="300px" width="100%" src="<?=base_url('uploads/slider/'.$r->img_name)?>">
                    </div>
                  <?php } ?>
                </div>
              </div>
