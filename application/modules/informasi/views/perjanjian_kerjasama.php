<div class="main--breadcrumb">
    <div class="container">
        <ul class="breadcrumb">
            ...
            <li class="active"><span>Perjanjian Kerjasama</span></li>
        </ul>
    </div>
</div>
            ...
            <div class="main--content col-md-9 col-sm-7" data-sticky-content="true">
                <div class="sticky-content-inner">
                    <div class="page--title ptop--30">
                        <h2 class="h2">Perjanjian Kerjasama</h2> </div>
                                ...
                                <div class="post--item post--title-larger">
                                    <div class="row">
                                        ...
                                        <div class="col-md-8 col-sm-12 col-xs-8 col-xxs-12">
                                            <div class="post--info">
                                                <div class="title">
                                                    <h3 class="h4"><?=$entry->description?></h3> 
                                            </div>
                                            </div>
                                            <div class="post--action"> <a href="<?=$entry->url?>"><i class="fa fa-download"></i> Unduh</a> </div>
                                        </div>
                                    </div>
                                </div>
                            </li>
