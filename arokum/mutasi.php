                 ...
                 <table class="table table-striped table-bordered table-hover dataTables-example" >
                  ...
                  <td>$i[pendidikan]</td>
                                    ...
                                    <td style='width:70px'><center>
                                       <a class='open-AddBookDialog' data-id='$i[id_mutasi]' data-id1='$i[nama]' data-id2='$i[nip]' data-id3='$i[pangkat]' data-id5='$i[jabatan]' data-id5='$i[tgl_tmt]'data-id6='$i[masa_kerja]' data-id7='$i[pendidikan]' data-id8='$i[catatan_mutasi]'  style='margin-right:10px' data-toggle='modal' href='#' data-target='#editmutasi' title='Edit Data ini'><i class='fa fa-pencil-square-o'></i></a>
                                     <a href='index.php?view=mutasi&delete=$i[id_mutasi]' title='Hapus Data ini' onclick=\"return confirm('Apakah anda Yakin Data ini Dihapus?')\" ><i class='fa fa-trash-o'></i></a>
                                    </center></td>
                                 </tr>";
                            $no++;
                        }
...
<?php 
    if (isset($_POST[simpan])){
        ...
        mysql_query("INSERT INTO mutasi VALUES('','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$_POST[e]','$_POST[f]','$_POST[g]','$_POST[h]')");
            echo "<script>document.location='mutasi.mu';</script>";
    }
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          ...
          <div class="modal-body">
              <form class="form-horizontal" action="mutasi.mu" method='POST'>
                ...
                <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="c" required>
                            ...
                            <div class="form-group">
                                <label class="col-lg-3 control-label">TMT Golongan</label>
                                <div class="col-sm-8">
