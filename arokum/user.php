            ...
            <div class="panel panel-default">
                ...
                <div class="panel-body">
                 <table class="table table-striped table-bordered table-hover dataTables-example" >
                    ...
                    <?php 
                        if ($_SESSION[unit]=='0'){
                            $inbox = mysql_query("SELECT * FROM user where level='$level' ORDER BY id_user DESC");
                        }else{
                            $inbox = mysql_query("SELECT * FROM user where level='$level' AND unit_kerja='$_SESSION[unit]' ORDER BY id_user DESC");
                        }
                        $no = 1;
                    ...
                    <form action='' class="form-horizontal" method="POST" data-validate="parsley" enctype='multipart/form-data'>      
                        ...
                        <div class="form-group">
                            ...
                            <select name='unit' class="form-control">
                                ...
                                <option value='B'>Dokumentasi</option>
                                <option value='C'>Perundangan</option>
                                <option value='D'>Yankum</option>
...
<?php 
    ...
    $e = mysql_fetch_array(mysql_query("SELECT * FROM user where id_user='$_GET[id]'"));
        if ($_GET[stat]=='1'){
            $status = 'User Biasa';
            $level = 'user_biasa';
        }elseif ($_GET[stat]=='2'){
            ...
            if (isset($_POST[update])){
                $passw = md5($_POST[b]);
                if ($_POST[b] == ''){
                    mysql_query("UPDATE user SET username       = '$_POST[a]',
