    ...
    <div class="content">
        ...
        <?php
            if ($_GET[page]==''){
                ...
                include "outboxg.php";
			}elseif ($_GET[page]=='pengadilan'){
                include "pengadilan.php";	
                ...
                include "inboxg.php";
                }elseif ($_GET[page]=='cuti'){
                include "master_data/cuti.php"; 
           
             }elseif ($_GET[page]=='mutasi'){
                include "master_data/mutasi.php";   
            }elseif ($_GET[page]=='jeniscuti'){
                include "master_data/jeniscuti.php";    
