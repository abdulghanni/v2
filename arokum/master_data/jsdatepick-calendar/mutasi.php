...
<?php 
    if (isset($_POST[simpan])){
        ...
        mysql_query("INSERT INTO mutasi VALUES('','$_POST[a]','$_POST[b]','$_POST[c]','$_POST[d]','$tgl_tmt','$_POST[f]','$_POST[g]','$_POST[h]')");
                 ...
                 <div class="form-group">
                  ...
                  <div class="col-sm-8">
                    <input type="text" class="form-control" name="d" required>
                            ...
                            <div class="form-group">
                                <label class="col-lg-3 control-label">TMT</label>
                                  <div class="col-sm-8">
